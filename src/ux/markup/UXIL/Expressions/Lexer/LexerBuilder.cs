...
namespace Uno.UX.Markup.UXIL.Expressions.Lexer
{
    class LexerBuilder
    {
        ...
        public int[][] Build()
        {
            ...
            Build(TokenType.ColorCodeLiteral, root['#'],
                "0123456789ABCDEFabcdef", HexadecimalChars,
                EmitPreprocessorDirective);
        ...
        void BuildDouble(int scanNumber, int scanDouble)
        {
            ...
            })
            {
                ...
                Build(TokenType.PixelLiteral, a, "xX");
                Build(TokenType.PointLiteral, a, "tT");
            }
