// This file was generated based on Library/Core/UnoCore/Source/Uno/Float2.uno.
...
namespace Uno
{
    ...
    public struct Float2
    {
        ...
        public static implicit operator Float2(Byte2 a)
        {
            return new Float2((float)a.X, (float)a.Y);
        }

        public static implicit operator Float2(SByte2 a)
        {
            return new Float2((float)a.X, (float)a.Y);
        }

        public static implicit operator Float2(UShort2 a)
        {
            return new Float2((float)a.X, (float)a.Y);
        }

        public static implicit operator Float2(Short2 a)
        {
            return new Float2((float)a.X, (float)a.Y);
        }
