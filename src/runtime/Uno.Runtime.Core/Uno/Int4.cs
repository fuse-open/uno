// This file was generated based on Library/Core/UnoCore/Source/Uno/Int4.uno.
...
namespace Uno
{
    ...
    public struct Int4
    {
        ...
        public static implicit operator Int4(Byte4 v)
        {
            return new Int4((int)v.X, (int)v.Y, (int)v.Z, (int)v.W);
        }

        public static implicit operator Int4(SByte4 v)
        {
            return new Int4((int)v.X, (int)v.Y, (int)v.Z, (int)v.W);
        }

        public static implicit operator Int4(UShort4 v)
        {
            return new Int4((int)v.X, (int)v.Y, (int)v.Z, (int)v.W);
        }

        public static implicit operator Int4(Short4 v)
        {
            return new Int4((int)v.X, (int)v.Y, (int)v.Z, (int)v.W);
        }
