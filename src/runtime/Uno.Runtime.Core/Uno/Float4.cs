// This file was generated based on Library/Core/UnoCore/Source/Uno/Float4.uno.
...
namespace Uno
{
    ...
    public struct Float4
    {
        ...
        public static implicit operator Float4(Byte4 a)
        {
            return new Float4((float)a.X, (float)a.Y, (float)a.Z, (float)a.W);
        }

        public static implicit operator Float4(SByte4 a)
        {
            return new Float4((float)a.X, (float)a.Y, (float)a.Z, (float)a.W);
        }

        public static implicit operator Float4(UShort4 a)
        {
            return new Float4((float)a.X, (float)a.Y, (float)a.Z, (float)a.W);
        }

        public static implicit operator Float4(Short4 a)
        {
            return new Float4((float)a.X, (float)a.Y, (float)a.Z, (float)a.W);
        }
