...
{
    public sealed class RemoveListener : CallExpression
    {
        public Event Event;
        public Expression Listener;

        public RemoveListener(Source src, Expression obj, Event @event, Expression listener)
            : base(src)
        {
            Object = obj;
            Event = @event;
        ...
        public override ExpressionType ExpressionType => ExpressionType.RemoveListener;

        public override Function Function => Event.RemoveMethod;
        ...
        {
            return new RemoveListener(Source, Object.CopyNullable(state), state.GetMember(Event), Listener.CopyExpression(state));
        }
    }
}